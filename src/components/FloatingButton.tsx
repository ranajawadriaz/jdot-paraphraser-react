  ...
  return (
    ...
    >
      <Button 
        onClick={onClick}
        disabled={isLoading}
        className="bg-paraphraser-primary hover:bg-paraphraser-hover text-white rounded-full shadow-md transition-all duration-300 hover:scale-105 text-xs sm:text-sm"
        size="sm"
      >
